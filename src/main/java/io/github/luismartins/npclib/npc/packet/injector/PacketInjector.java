package io.github.luismartins.npclib.npc.packet.injector;

import io.github.luismartins.npclib.npc.packet.reader.PacketReader;
...
public class PacketInjector {
    ...
    public PacketInjector() {
        try {
            EntityPlayer_playerConnection = ReflectionUtil.getField(ReflectionUtil.getCraftClass("EntityPlayer"),
                    "playerConnection");
